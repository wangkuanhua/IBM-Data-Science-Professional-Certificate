...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df=filtered_df.groupby(['Launch Site','class']).size().reset_index(name='count of class')
        fig=px.pie(filtered_df,values='count of class',names='class',title=f"Total Success Launches for site {entered_site}")
        return fig
